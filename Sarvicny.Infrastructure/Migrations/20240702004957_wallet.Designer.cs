...
namespace Sarvicny.Infrastructure.Migrations
{
    ...
    [Migration("20240702004957_wallet")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.District", b =>
                {
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.ProviderDistrict", b =>
                {
                    b.Property<string>("ProviderDistrictID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasKey("ProviderDistrictID");

                    b.HasIndex("DistrictID");

                    b.HasIndex("ProviderID");

                    b.ToTable("ProviderDistricts");
                });
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.ProviderWallet", b =>
                {
                    b.Property<string>("WalletId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");

                    b.Property<decimal>("HandedBalance")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.ToTable("ProviderWallets");
                });

            modelBuilder.Entity("Sarvicny.Domain.Entities.RequestedService", b =>
                {
                    b.Property<string>("RequestedServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.TransactionPayment", b =>
                {
                    b.Property<string>("TransactionPaymentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<int>("TransactionPaymentStatus")
                        .HasColumnType("int");

                    b.Property<string>("TransactionPaymentStatusString")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Sarvicny.Domain.Entities.TransactionPayment", "TransactionPayment")
                        .WithMany("OrderList")
                        .HasForeignKey("TransactionPaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sarvicny.Domain.Entities.OrderRating", "CRate")
                        .WithOne()
                        .HasForeignKey("Sarvicny.Domain.Entities.Order", "customerRatingId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Sarvicny.Domain.Entities.OrderRating", "PRate")
                        .WithOne()
                        .HasForeignKey("Sarvicny.Domain.Entities.Order", "providerRatingId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.ProviderDistrict", b =>
                {
                    b.HasOne("Sarvicny.Domain.Entities.District", "District")
                        .WithMany("ProviderDistricts")
            ...
            modelBuilder.Entity("Sarvicny.Domain.Entities.Cart", b =>
                {
                    b.Navigation("CartServiceRequests");

    ...
    public partial class wallet : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PendingBalance = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    HandedBalance = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    TotalBalance = table.Column<decimal>(type: "decimal(65,30)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderWallets", x => x.WalletId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionPaymentID = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TransactionID = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Amount = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    SaleID = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PaymentMethod = table.Column<int>(type: "int", nullable: true),
                    TransactionPaymentStatus = table.Column<int>(type: "int", nullable: false),
                    TransactionPaymentStatusString = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PaymentDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    PaymentExpiryTime = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceProviders_ProviderWallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProblemDescription = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReAssigned = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestedServiceId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ServiceId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    CartId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CartServiceRequestID = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OrderDetailsID = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestedServices_CartServiceRequests_CartServiceRequestID",
                        column: x => x.CartServiceRequestID,
                        principalTable: "CartServiceRequests",
                        principalColumn: "CartServiceRequestID");
                    table.ForeignKey(
                        name: "FK_RequestedServices_OrderDetails_OrderDetailsID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_TransactionPayment_TransactionPaymentId",
                        column: x => x.TransactionPaymentId,
                        principalTable: "TransactionPayment",
                        principalColumn: "TransactionPaymentID",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TransactionPaymentId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestedServices_CartServiceRequestID",
                table: "RequestedServices",
                column: "CartServiceRequestID");

            migrationBuilder.CreateIndex(
                name: "IX_RequestedServices_OrderDetailsID",
                table: "RequestedServices",
                column: "OrderDetailsID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviders_WalletId",
